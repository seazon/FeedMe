FeedMe is an reader client application for RSS services:
- Feedbin
- Feedly
- Fever API
  - CommaFeed
...
## Version:
- Google Play release: 4.8.6
- Google Play beta: 4.9.3 (join beta test: https://play.google.com/apps/testing/com.seazon.feedme)
- Github: 4.9.5
